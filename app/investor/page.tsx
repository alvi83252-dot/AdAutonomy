  ...
  return (
    ...
    >
      {(c) => {
        ...
        const budget = (c.extractedBrief?.budget as number) || c.brief.budget || 5000;
        const adSpend = Math.round(budget * 0.6 * 100) / 100;
        ...
        return (
          <>
            ...
            <AnimatedCard className="mb-6">
              <h2 className="text-lg font-semibold text-blue-400 mb-2">PayPal Sandbox Checkout</h2>
              <p className="text-sm text-muted-foreground mb-4">
                Approve ad spend with a real sandbox buyer login — PaymentAgent ({adSpend.toFixed(2)} USD ad spend share).
              </p>
              <PayPalCheckout
                amount={adSpend}
                label="Campaign ad spend (60% of budget)"
              />
            </AnimatedCard>
